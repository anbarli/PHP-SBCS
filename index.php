...
<html lang="en">
  <head>
    ...
    <title>PHP Session Based Cart System</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <footer>
        <p><a href="https://github.com/ganbarli/PHP-SBCS" target="blank">PHP-SBCS</a> (v1.5) is coded with <i class="glyphicon glyphicon-heart"></i> in İstanbul, <a href="http://www.turkeydiscoverthepotential.com/" target="blank">Türkiye</a></p>
      </footer>
